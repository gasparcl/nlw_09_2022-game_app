...
function App() {
    return (
        <div className='max-w-[1344px] mx-auto flex flex-col items-center my-20'>
            <img src={logoImg} alt="logo" className='h-44'/>
            ...
            <div className='grid grid-cols-6 gap-6 mt-16'>
                <a href="" className='relative rounded-md overflow-hidden'>
                    ...
                    <div className='w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0'>
                        ...
                        <span className='text-zinc-300 text-sm block'>16 anúncios</span>
                    </div>
                </a>
                <a href="" className='relative rounded-md overflow-hidden'>
            ...
            <div className='pt-1 bg-nlw-gradient self-stretch mt-8 rounded-md overflow-hidden'>
                <div className='bg-[#2A2634] px-8 py-6 flex justify-between items-center'>
                    ...
                    <button className='py-3 px-4 bg-violet-500 hover:bg-violet-600 transition-all rounded-md text-white font-medium flex items-center gap-3'>
